...
public class BitmapsChecksumTest {
  ...
  public static Collection<Object[]> data() {
    return Arrays.asList(new Object[][]{
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(new Dimension(500, 500)), FilterType.Bessel,
            "101-6467-126-3534108-8927-58-26-37248672"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(new Dimension(500, 800)), FilterType.Box,
            "-748135-126-6412111-11925-1038826-95-32-6-104"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(new Dimension(4000, 5500)), FilterType.Box,
            "-646510160-466410970-77-1031184396-8-23-18"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(new Dimension(600, 300)), FilterType.Bessel,
            "-69-11478-721003586-100-72-85-1559101-118-24-94"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(2, 2, 0, 0), FilterType.Bessel,
            "-4979-94-68-125645751-2111712617-59-295"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(2, 2, 0, 0), FilterType.Lanczos,
            "-4979-94-68-125645751-2111712617-59-295"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(3, 3, 1, 1), FilterType.Lanczos,
            "84-1069410599-9575-7934-1279-80-85127-18-128"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(new Rectangle(100, 100, 500, 500)),
            FilterType.Lanczos, "-80114-104-9-15-13-41-27-94-31-1276416-123-41-7"
        },
        {
            "/images/042_1.jb2", 1, new ParameterizedImageReadParam(new Rectangle(500, 500, 2000, 2000)),
            FilterType.Lanczos, "-60-45-117-90-6596-11556-47-30-112-741138412082"
        },
        {
            "/images/042_1.jb2", 1,
            new ParameterizedImageReadParam(new Rectangle(500, 500, 2000, 2000), new Dimension(678, 931)),
            FilterType.Lanczos, "-17-95-5543-12062-625054-94-88-31-4-120-1971"
        },
        {
            "/images/042_1.jb2", 1,
            new ParameterizedImageReadParam(new Rectangle(500, 500, 2000, 2000), new Dimension(678, 931), 3, 3, 1, 1),
  ...
  private static class ParameterizedImageReadParam extends ImageReadParam {
    public ParameterizedImageReadParam(Rectangle sourceRegion) {
      this.sourceRegion = sourceRegion;
    }

    public ParameterizedImageReadParam(Dimension sourceRenderSize) {
      this.sourceRenderSize = sourceRenderSize;
    }

    public ParameterizedImageReadParam(int sourceXSubsampling, int sourceYSubsampling, int subsamplingXOffset,
    ...
    public ParameterizedImageReadParam(Rectangle sourceRegion, Dimension sourceRenderSize) {
      this.sourceRegion = sourceRegion;
      this.sourceRenderSize = sourceRenderSize;
    }

    public ParameterizedImageReadParam(Rectangle sourceRegion, Dimension sourceRenderSize, int sourceXSubsampling,
  ...
  static class RasterChecksumCalculator {
    public static void main(String[] args) throws IOException, JBIG2Exception, NoSuchAlgorithmException {
      ...
      final ImageReadParam param = new ParameterizedImageReadParam(new Rectangle(500, 500, 2000, 2000), new Dimension(
          678, 931), 3, 3, 1, 1);
