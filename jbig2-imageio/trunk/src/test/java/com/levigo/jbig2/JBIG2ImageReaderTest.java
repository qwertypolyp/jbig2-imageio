...
public class JBIG2ImageReaderTest {
	...
	public void testRead() throws IOException, InvalidHeaderValueException,
		...
		JBIG2ImageReader imageReader = new JBIG2ImageReader(
				new JBIG2ImageReaderSpi(), true);
		
		imageReader.setInput(imageInputStream);
		JBIG2ReadParam param = new JBIG2ReadParam(1, 1, 0, 0, new Rectangle(0, 0,
				500, 800), new Dimension(500, 800));
	...
	@Ignore
	@Test
	public void testReadIntImageReadParamNotEmbedded() throws IOException,
